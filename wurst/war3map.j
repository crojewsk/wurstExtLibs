globals
    // User-defined
location array udg_positions

    // Generated
trigger gg_trg_Initialization_Settings= null
...
//===========================================================================
// 
// ItemRestriction system
// 
//   Warcraft III map script
//   Generated by the Warcraft III World Editor
//   Date: Sat May 26 20:56:21 2018
//   Map Author: Bannar
// 
//===========================================================================
...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem('desc', - 254.5, 325.1)
    call CreateItem('desc', - 145.3, 328.8)
    call CreateItem('desc', - 145.9, 224.0)
    call CreateItem('desc', - 255.3, 221.0)
    call CreateItem('mlst', - 533.7, - 124.3)
    call CreateItem('mlst', - 533.1, - 15.6)
    call CreateItem('mlst', - 634.2, - 24.8)
    call CreateItem('mlst', - 637.4, - 136.9)
    call CreateItem('sprn', - 291.9, 11.3)
endfunction
...
//===========================================================================
// Trigger: Initialization Settings
//===========================================================================
function Trig_Initialization_Settings_Func008A takes nothing returns nothing
    set udg_positions[GetUnitUserData(GetEnumUnit())]=GetUnitLoc(GetEnumUnit())
endfunction

function Trig_Initialization_Settings_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsInRectOfPlayer(GetPlayableMapRect(), Player(1)), function Trig_Initialization_Settings_Func008A)
    // --------------------------------------------
...
//===========================================================================
function InitTrig_Initialization_Settings takes nothing returns nothing
    set gg_trg_Initialization_Settings=CreateTrigger()
    call TriggerRegisterTimerEventSingle(gg_trg_Initialization_Settings, 0.00)
    call TriggerAddAction(gg_trg_Initialization_Settings, function Trig_Initialization_Settings_Actions)
endfunction

//===========================================================================
function InitCustomTriggers takes nothing returns nothing
    call InitTrig_Initialization_Settings()
endfunction
